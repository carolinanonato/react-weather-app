...
import { AccordionItemHeading, AccordionItem, AccordionItemPanel, AccordionItemButton } from "react-accessible-accordion";
import "./forecast.css";
...
const Forecast = ({ data }) => {
    ...
    return (
        <>
            <label className="title">Week Ahead</label>
